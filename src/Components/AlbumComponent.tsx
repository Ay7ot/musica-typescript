...
import { RiPlayListAddFill, RiPlayCircleFill, RiHeart2Fill, RiHeart2Line } from 'react-icons/ri'
  ...
  return (
    <div>
      <div className="md:flex gap-5">
        ...
        <div className='md:mt-[100px] lg:mt-[150px]'>
          <div className='lg:w-[500px]'>
            <h2 className='text-[#A4C7C6] text-[32px] font-bold mt-6 md:w-[60%] lg:w-[100%]'>{data.name}</h2>
            {
              //@ts-ignore
          ...
          <div className='flex justify-between mt-6 lg:w-[400px]'>
                ...
                return (
                    <div className='flex items-center justify-between bg-[#2c2f31] p-2 rounded-xl mb-4' key={item.id}>
                        <div className='flex items-center'>
                          ...
                          <i className='hidden md:block ml-5 text-[1.2rem]'><RiHeart2Line /></i>
                        </div>
                        <div className='w-[400px] lg:w-[600px] flex justify-between'>
                          <p className='text-sm text-white font-thin tracking-wide mb-0'>{item.name}</p>
                          <p className='text-xs lg:text-sm text-white font-thin tracking-wider text-end'>{item.artist}</p>
                        </div>
                        <div className='flex items-center md:flex-row-reverse lg:items-center'>
